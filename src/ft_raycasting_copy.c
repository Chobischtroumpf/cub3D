...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_raycasting_copy.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: adorigo <adorigo@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/16 11:18:33 by adorigo           #+#    #+#             */
/*   Updated: 2020/01/31 15:07:19 by adorigo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	ray = cub3d->ray;
// 	map[0] = (int)(cub3d->player->pos->y);
// 	map[1] = (int)(cub3d->player->pos->x);
// 	hit = 0;
// 	while (hit != 1)
// 	{
...
// 	if (is_side == 1)
// 		ray->dist =
// 			(map[0] - cub3d->player->pos->y + (1 - step[0]) / 2) / ray->dir->y;
// 	else
// 		ray->dist =
// 			(map[1] - cub3d->player->pos->x + (1 - step[1]) / 2) / ray->dir->x;
